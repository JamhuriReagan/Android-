...
import com.example.reagananroidproject.FormActivity
import com.example.reagananroidproject.R
                ...
                Column {
                    Card(
                        ...
                        Box(modifier = Modifier.fillMaxWidth(),
                            ...
                            Image(
                                painter = painterResource(id = R.drawable.dest3) ,
                    ...
                    Spacer(modifier = Modifier.height(5.dp))
                    Row {
                        Icon(imageVector = Icons.Default.Star, contentDescription ="Start", tint = Color.Green )
                        Icon(imageVector = Icons.Default.Star, contentDescription ="Start", tint = Color.Green)
                        Icon(imageVector = Icons.Default.Star, contentDescription ="Start", tint = Color.Green )
                        Icon(imageVector = Icons.Default.Star, contentDescription ="Start", tint = Color.Green)
                        Icon(imageVector = Icons.Default.Star, contentDescription ="Start", tint = Color.Green )
