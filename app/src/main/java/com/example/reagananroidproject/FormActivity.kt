    ...
    Column (modifier = Modifier
       ...
       Box (modifier = Modifier
        ...
        OutlinedTextField(
            ...
            placeholder = { Text(text = "Firstname", color = Color.Black) },
        ...
        OutlinedTextField(
            ...
            placeholder = { Text(text = "Lastname", color = Color.Black) },
            leadingIcon = { Icon(imageVector = Icons.Default.Person, contentDescription = "person") },
            modifier = Modifier
                .fillMaxWidth()
                .padding(start = 20.dp, end = 20.dp),
        ...
        OutlinedTextField(
            value = firstname,
            onValueChange = {firstname=it},
            placeholder = { androidx.compose.material3.Text(text = "Location", color = Color.Black)},
